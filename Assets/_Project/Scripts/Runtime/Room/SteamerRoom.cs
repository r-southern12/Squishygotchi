...
namespace Squishy.Runtime.Room
{
    ...
    {
        [Header("Shape")]
        [Tooltip("Radius at room width 1x (level 4). Level 2 is 0.77x, about 2.3 units.")]
        [SerializeField] private float radiusAtFullWidth = 3f;
        [SerializeField] private float wallHeight = 1.35f;
        [SerializeField] private float slatSpacing = 0.52f;
        ...
        public void Build(float relativeWidth)
        {
            ...
            Radius = radiusAtFullWidth * relativeWidth;
            FloorY = 0.19f;
            ...
            int count = Mathf.Max(12, Mathf.RoundToInt(2f * Mathf.PI * Radius / slatSpacing));
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                s.Body = Part("Slat", slatMesh, i % 2 == 0 ? slatColorA : slatColorB, dir * Radius, rot);
        ...
        private Transform Part(string name, Mesh mesh, string hex, Vector3 position, Quaternion? rotation = null, bool castShadows = true)
        {
            ...
            r.sharedMaterial = _palette.Get(MaterialPalette.Hex(hex));
